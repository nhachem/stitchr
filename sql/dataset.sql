...
CREATE TABLE
    ...
    (
        ...
        schema_id INTEGER, -- points to schema_column.schema_id (not a real FK as the schema is denormalized)
...
alter table dataset add constraint uk_name_datasource_idx unique using index uk_name_datasource_idx;
-- TODO add FKs here
...
ALTER TABLE dataset ADD COLUMN add_run_time_ref boolean default false;
ALTER TABLE dataset ADD COLUMN write_mode varchar(15) default 'append';
