...
ss2.catalog.container.table("q4_3").show(False)
sc2.tables().show()

ss4.catalog.container.table("q2_3").show(False)
## envirornment that  we can work with ss2 or ss4 ... as those are containers to the spark session on the jvm side
sc4.tables().show()

ss4.catalog.container.table("q4_3").show(False)
